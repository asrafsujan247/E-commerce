...
interface SearchScreenClothingProps {
  products?: Product[];
...
const SearchScreenClothing: React.FC<SearchScreenClothingProps> = ({
  products,
  attributes,
  categories,
  searchQuery,
  ...
  type SortableProduct = Product & { prices?: { price?: number }; createdAt?: string };
