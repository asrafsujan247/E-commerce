 ...
 * @param lang - UI language code (e.g., "en", "bn")
...
export function formatPrice(
  ...
  const num = Number(parseFloat(String(value || 0)).toFixed(2));
 ...
 */
export function formatNumber(value: number | string, lang = "en"): string {
  const num = Number(parseFloat(String(value || 0)).toFixed(2));
